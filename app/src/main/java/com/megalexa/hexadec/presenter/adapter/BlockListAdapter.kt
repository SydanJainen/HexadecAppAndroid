...
class BlockListAdapter(context: Context, arrayListImage: ArrayList<Int>, name: Array<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (myView == null) {
            ...
            */
            holder.mImageView = myView!!.findViewById<ImageView>(R.id.icon) as ImageView
